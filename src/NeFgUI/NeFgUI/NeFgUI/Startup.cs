...
using NeFgUI.Authorization;
using NeFgUI.Helpers;
using NeFgUI.ViewModels;
...
namespace NeFgUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("NeFgUI"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "NeFgUI API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "NeFgUI API V1");
            });
